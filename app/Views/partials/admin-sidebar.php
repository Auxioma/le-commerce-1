...
$sidebarSections = [
    ...
    'Fidélisation' => [
        ...
        '/admin/loterie'      => ['Loterie', 'M12 8c-1.5-3-6-3-6 0s4.5 3 6 6c1.5-3 6-3 6-6s-4.5-3-6 0z'],
    ...
    'Pilotage' => [
        ...
        '/admin/google-analytics'  => ['Google Analytics', 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6'],
...
$implementedRoutes = ['/admin', '/admin/clients', '/admin/etablissement', '/admin/services', '/admin/images', '/admin/employes', '/admin/portefeuilles', '/admin/messages', '/admin/reservations', '/admin/offres', '/admin/offres/scanner', '/admin/sondages', '/admin/loterie', '/admin/zonage', '/admin/avis-google', '/admin/statistiques', '/admin/google-analytics', '/admin/facturation', '/admin/parametres'];
?>
