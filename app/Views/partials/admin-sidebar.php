...
$implementedRoutes = ['/admin', '/admin/clients', '/admin/etablissement', '/admin/services', '/admin/images', '/admin/employes', '/admin/portefeuilles', '/admin/messages', '/admin/reservations', '/admin/offres', '/admin/offres/scanner', '/admin/sondages', '/admin/loterie', '/admin/zonage', '/admin/avis-google', '/admin/statistiques', '/admin/facturation', '/admin/parametres'];
?>
